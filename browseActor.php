...
<html>
  ...
  <body style="background-color:powderblue;">
    ...
    <h4 style="font-family:courier;"><a href='search.php?type=Actor'>Go to Search Page for Actors</a></h4>    
    <h1 style="font-family:courier;">Actors:</h1>
...
<!---The paging mechanism below borrows from phpjabbers.com "PHP/MySQL Select Data and Split on Pages"--->
    <?php
       ...
       $baseQuery = "Select Distinct * From Actor Order By id ASC LIMIT ".$resultsPerPage." OFFSET ".$offset;
